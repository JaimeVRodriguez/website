...
export const projects: Project[] = [
    {
        ...
        image: chatbot,
        description: 'A console application that allows users to order multiple coffee drinks. Built ' +
            'to scale with a cafe\'s menu and options.',
    ...
    },
    {
        title: 'ATS Hacker',
        image: hacker,
        description: 'A job posting keyword counter with command line and web interfaces. Maximize your ' +
            'application\'s chances by ensuring the most used words from the job posting are in your resume.',
    ...
    },
    {
        ...
        image: sof,
        description: 'Analyzes Special Operations selection data for Special Forces and Psychological ' +
            'Operations. Includes a predictive model for selection results based on candidate attributes.',
